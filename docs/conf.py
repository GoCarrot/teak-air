...
project = u'Teak for Adobe AIR'
copyright = u'2017-2019, GoCarrot Inc'
author = u'Teak'
...
version = unicode(git_version.split("-")[0], 'utf-8')
# The full version, including alpha/beta/rc tags.
release = unicode(git_version, 'utf-8')
...
htmlhelp_basename = 'TeakforAdobeAIRdoc'
...
latex_documents = [
    (master_doc, 'TeakforAdobeAIR.tex', u'Teak for Adobe AIR Documentation',
     u'GoCarrot Inc', 'manual'),
]
...
man_pages = [
    (master_doc, 'teakforadobeair', u'Teak for Adobe AIR Documentation',
     [author], 1)
]
